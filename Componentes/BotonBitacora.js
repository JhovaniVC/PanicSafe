...
export default function MainMenu({ navigation }) { // Asegúrate de que navigation esté como prop
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <TouchableOpacity 
        ...
        onPress={() => navigation.navigate('BitacoraPersonal')}> {/* Asegúrate de que el nombre de la ruta sea correcto */}
      ...
      <View style={styles.navBar}>
        <TouchableOpacity style={styles.navItem} onPress={() => showAlert('Actividad')}>
          <Icon name="bell" size={20} color="#fff" />
          <Text style={styles.navText}>Actividad</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.navItem} onPress={() => showAlert('Configuracion')}>
          <Icon name="gear" size={24} color="#fff" />
          <Text style={styles.navText}>Configuración</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.navItem} onPress={() => showAlert('Home')}>
          <Icon name="home" size={24} color="#fff" />
          <Text style={styles.navText}>Home</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.navItem} onPress={() => showAlert('User')}>
